    ...
    <>
      <section className="relative bg-[#004D4F] py-14 px-4 md:px-16 overflow-hidden">
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="absolute top-0 right-0 w-64 h-64 rounded-full bg-[#015b5d] -translate-y-1/4 translate-x-1/4 z-0"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-0 left-0 w-56 h-56 rounded-full bg-[#015b5d] translate-y-1/3 -translate-x-1/3 z-0"
        />
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/4 w-24 h-24 rounded-full bg-[#015b5d] blur-sm z-0 opacity-40"
        />
        ...
        <motion.div
          ...
          className="absolute bottom-1/3 right-1/4 w-32 h-32 rounded-full bg-[#015b5d] blur-sm z-0 opacity-40"
        />
        ...
        <div className="relative z-10 max-w-7xl mx-auto">
          ...
          <motion.h2
            ...
            initial="hidden"
            animate="visible"
            className="text-white text-2xl md:text-4xl font-semibold mb-12 text-center"
          >
            Al Habib Travel{" "}
            <motion.span
              initial={{ color: "#fff" }}
              animate={{ color: "#FBBF24" }}
              transition={{
                duration: 1,
                delay: 0.8,
                repeat: Infinity,
            ...
            {stats.map((stat, index) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover="hover"
                  className={`bg-white border-amber-500 border-4 relative rounded-xl shadow-md p-5 w-full max-w-[300px] ${extraClasses}`}
                >
                  <h3 className="text-[#004D4F] lg:text-xl font-semibold text-base mb-1">
                    {stat.title}
                  </h3>
